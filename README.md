...
```
usage: dataclass_from_json.py [-h] [--class-name CLASS_NAME] [input_file]

Turn a JSON object into a Python `dataclass` definition.

positional arguments:
  input_file            A file from which to read a JSON data. (default: <_io.TextIOWrapper name='<stdin>' mode='r' encoding='utf-8'>)

options:
  -h, --help            show this help message and exit
  --class-name CLASS_NAME
                        The name of the dataclass to be produced. (default: C)
```

## Example

```
$ ./dataclass_from_json.py data.json --class-name 'GameInfo'
```
